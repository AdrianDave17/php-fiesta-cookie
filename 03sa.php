...
{echo "<br><br><b>'Pokemon's Defense'</b><br>";}
	...
	function pokemon_defense($pokemon, $limit_number){					
		for($i = 1; $i <= 10; $i++){
			/*
			if statemant inside a for loop to scan each pokemon if their defense is 
			greater than or equal to the limit number given.
			*/
	...
	21); #You can change the limit number here.
?>
